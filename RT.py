        ...
        try:
            ...
            for station in data.get("body", {}).get("stations", []):
                ...
                station_info = {
                    ...
                    "Station Congestion": 1,  # Placeholder
                    "Track Availability": 1,  # Placeholder
                    "Peak Hour Indicator": 1 if 17 <= datetime.now().hour <= 20 else 0
                }
...
def load_data_train_and_predict(_hyperparams, api_key, train_numbers, date):
    """
    ...
    df = fetch_train_data(api_key, train_numbers, date, debug=True)
